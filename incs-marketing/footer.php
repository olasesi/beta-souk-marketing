<!-- Footer Section 
	...
	<footer class="aplpg-footer-section" data-background="img/app-landing/betasouk_footer.png">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="aplpg-footer-widget">
						<a href="#" class="aplpg-footer-logo"><img src="img/app-landing/betasouk_logo-white.png" alt=""></a>
