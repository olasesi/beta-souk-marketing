...
<!-- Mirrored from webstrot.com/html/savehyip/light_version/my_account.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 11:02:42 GMT -->
        ...
        <nav class="c-menu js-menu" id="mynavi">
            ...
            <ul class="u-list crm_drop_second_ul">
                ...
                <li class="c-menu__item is-active has-sub crm_navi_icon_cont">
                    ...
                    <ul>
                      <li><a href="logout-my-account.php"><i class="fa fa-circle"></i> log out</a>
                            </li>
                    </ul>
                </li>
            </ul>
