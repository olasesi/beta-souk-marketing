					...
					<div class="col-12 col-md-6">
						<div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
						    ...
						    <div class="app-card-body px-4">
							    ...
							    <div class="intro mb-3">Let’s have a conversation. Feel free to talk to us if you need any other information or help.</div>
							    <ul class="list-unstyled">
								    <li><strong>Tel:</strong> <a href="tel:+234 708 929 2535"> 234 708 929 2535</a></li>
								    <li><strong>Email:</strong> <a href="mailto:sales@betasouk.com"> sales@betasouk.com</a></li>
							    </ul>
						    </div><!--//app-card-body-->
						    <div class="app-card-footer p-4 mt-auto">
							   <a class="btn app-btn-secondary" href="https://wa.me/2347089292535" target="blank">Start Live Chat</a>
						    </div><!--//app-card-footer-->
						</div><!--//app-card-->
					</div><!--//col-->
					<div class="col-12 col-md-6">
						<div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
						    ...
						    <div class="app-card-body px-4">
							    ...
							    <div class="intro mb-3">Want more? Upgrade your website to gain access and enjoy more functionalities on your website to make better sales and unlock seamless opportunities in eCommerce. </div>
							    <!-- <ul class="list-unstyled">
								    <li>
