    ...
    Basic: {
      ...
      APLPGCarousel: function () {
        ...
        $(".aplpg-testimonial-slider").slick({
          ...
          arrows: true,
          prevArrow:
            '<button type="button" class="prev-btn"><i class="fas fa-long-arrow-alt-right"></i></button>',
          nextArrow:
            '<button type="button" class="next-btn"><i class="fas fa-long-arrow-alt-left"></i></button>',
          responsive: [
            {
              breakpoint: 992,
              settings: {
